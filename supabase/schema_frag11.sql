...
CREATE POLICY "Teams are viewable by everyone" ON frag11_teams
  FOR SELECT USING (true);

-- Players: Public read access
CREATE POLICY "Players are viewable by everyone" ON frag11_players
  FOR SELECT USING (true);

-- Matches: Public read access
CREATE POLICY "Matches are viewable by everyone" ON frag11_matches
  FOR SELECT USING (true);

-- User Teams: Users can view their own teams
...
-- Contests: Public read access
CREATE POLICY "Contests are viewable by everyone" ON frag11_contests
  FOR SELECT USING (true);

-- Contest Entries: Users can view their own entries
...
-- Player Points: Public read access
CREATE POLICY "Player points are viewable by everyone" ON frag11_player_points
  FOR SELECT USING (true);
...
-- Trigger to update match stats when contests change
