        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={i}
                className={`group relative p-8 bg-gradient-to-br from-${feature.color}-500/5 to-transparent backdrop-blur-sm rounded-2xl border border-${feature.color}-500/20 hover:border-${feature.color}-400/50 transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(6,182,212,0.2)]`}
              >
                ...
                <div className="relative">
                  <div className={`inline-flex items-center justify-center w-16 h-16 bg-${feature.color}-500/10 rounded-xl mb-6 group-hover:bg-${feature.color}-500/20 transition-colors`}>
